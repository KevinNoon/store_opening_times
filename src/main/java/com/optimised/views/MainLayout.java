...
import com.optimised.views.about2.About2View;
...
public class MainLayout extends AppLayout {
    ...
    private MenuItemInfo[] createMenuItems() {
        return new MenuItemInfo[]{ //
                new MenuItemInfo("Core Times", LineAwesomeIcon.CLOCK_SOLID.create(), CoreTimesView.class), //

                new MenuItemInfo("About", LineAwesomeIcon.FILE.create(), AboutView.class), //

                new MenuItemInfo("About2", LineAwesomeIcon.FILE.create(), About2View.class), //
